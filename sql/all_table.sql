...
CREATE TABLE `logtxt_temp` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='临时存放分隔数据';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=104691 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `month_report_non_prod` (
  ...
  PRIMARY KEY (`id`),
  KEY `month_indicator_index` (`month_indicator`)
) ENGINE=InnoDB AUTO_INCREMENT=88359 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `schedule_newest` (
  ...
  `INSERT_DATE` date DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19447 DEFAULT CHARSET=utf8 COMMENT='schedule 当天';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `schedule_newest_non_prod` (
  ...
  `INSERT_DATE` date DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=61454 DEFAULT CHARSET=utf8 COMMENT='schedule 当天';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `special_schedule_non_prod`
--

DROP TABLE IF EXISTS `special_schedule_non_prod`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `special_schedule_non_prod` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `SCHEDULE_NAME` varchar(45) DEFAULT NULL,
  `STATUS` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2018-04-03 11:07:35
