...
CREATE TABLE `logtxt_temp` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=33004 DEFAULT CHARSET=utf8 COMMENT='临时存放分隔数据';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `logtxt_temp_2`
--

DROP TABLE IF EXISTS `logtxt_temp_2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `logtxt_temp_2` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `col1` varchar(50) DEFAULT NULL,
  `col2` varchar(50) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=164145 DEFAULT CHARSET=utf8 COMMENT='临时存放分隔数据';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=74361 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `month_report_non_prod` (
  ...
  PRIMARY KEY (`id`),
  KEY `month_indicator_index` (`month_indicator`)
) ENGINE=InnoDB AUTO_INCREMENT=64507 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `schedule` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3071 DEFAULT CHARSET=utf8 COMMENT='schedule 当天';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `schedule_newest` (
  ...
  `INSERT_DATE` date DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5111 DEFAULT CHARSET=utf8 COMMENT='schedule 当天';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `schedule_newest_non_prod` (
  ...
  `INSERT_DATE` date DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=54267 DEFAULT CHARSET=utf8 COMMENT='schedule 当天';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `schedule_temp` (
  ...
  `INSERT_DATE` date DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2048 DEFAULT CHARSET=utf8 COMMENT='schedule 当天';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-03-16 16:50:52
